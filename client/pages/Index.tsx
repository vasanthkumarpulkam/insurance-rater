...
export default function Index() {
  ...
  const [modelPerformance, setModelPerformance] = useState<
    Record<string, MLModelPerformance>
  >({});
  ...
  const calculateRisk = (input: RiskAssessmentInput): RiskResult => {
    ...
    if (input.violations > 0) {
      reasons.push(
        `${input.violations} traffic violation(s) significantly increase risk`,
      );
    }
    ...
    if (input.accidents > 0) {
      reasons.push(
        `${input.accidents} accident(s) significantly increase risk`,
      );
    }
  ...
  const validateForm = (): boolean => {
    ...
    if (
      !formData.driverAge ||
      formData.driverAge < 16 ||
      formData.driverAge > 100
    ) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Auto Liability Insurance Risk Prediction
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
              ...
              <Card className="shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>
                    Enter broker/agent submission details to calculate risk
                    score and premium suggestions
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("driverAge", e.target.value)
                          }
                          className={
                            errors.driverAge ? "border-destructive" : ""
                          }
                          required
                        />
                        {errors.driverAge && (
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            handleInputChange("vehicleAge", e.target.value)
                          }
                          className={
                            errors.vehicleAge ? "border-destructive" : ""
                          }
                          required
                        />
                        {errors.vehicleAge && (
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleInputChange("violations", value)
                          }
                        >
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleInputChange("accidents", value)
                          }
                        >
                          <SelectTrigger>
                      ...
                      <div className="space-y-2 sm:col-span-2">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleInputChange("priorClaims", value)
                          }
                        >
                          <SelectTrigger>
                ...
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <p className="text-blue-100 max-w-2xl mx-auto">
                      ...
                      to provide accurate risk scores and premium suggestions
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Train and manage Random Forest, XGBoost, and Explainable
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Button
                      ...
                      variant={
                        mlStatus.datasetGenerated ? "outline" : "default"
                      }
                    >
                      {mlStatus.generating ? (
                        <>
              ...
              {mlStatus.modelsLoaded && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Get predictions from trained machine learning models
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        <div className="mt-4 p-4 border rounded-lg bg-blue-50">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <div className="font-medium">
                                {(mlResult.claim_probability * 100).toFixed(1)}%
                              </div>
                            </div>
                            <div>
                              <div className="text-gray-500">
                              ...
                              <div className="font-medium">
                                ${mlResult.suggested_premium.toLocaleString()}
                              </div>
                            </div>
                            <div>
              ...
              {datasetStats && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Overview of the synthetic insurance dataset
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary">
                          {datasetStats.total_samples.toLocaleString()}
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary">
                          {(datasetStats.claim_rate * 100).toFixed(1)}%
                        </div>
                        <div className="text-sm text-gray-600">Claim Rate</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary">
                          {datasetStats.avg_risk_score.toFixed(0)}
                        </div>
                        <div className="text-sm text-gray-600">
                          Avg Risk Score
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-primary">
                          ${datasetStats.avg_premium.toFixed(0)}
                        </div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="text-sm text-gray-600">
                            Mean:{" "}
                            {datasetStats.feature_stats.driver_age.mean.toFixed(
                              1,
                            )}{" "}
                            years
                            <br />
                            Range: {datasetStats.feature_stats.driver_age.min}-
                            {datasetStats.feature_stats.driver_age.max} years
                          </div>
                        </div>
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="text-sm text-gray-600">
                            Mean:{" "}
                            {datasetStats.feature_stats.vehicle_age.mean.toFixed(
                              1,
                            )}{" "}
                            years
                            <br />
                            Range: {datasetStats.feature_stats.vehicle_age.min}-
                            {datasetStats.feature_stats.vehicle_age.max} years
                          </div>
                        </div>
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="text-sm text-gray-600">
                            Mean:{" "}
                            {datasetStats.feature_stats.violations.mean.toFixed(
                              2,
                            )}
                            <br />
                        ...
                        <div className="p-4 border rounded-lg">
                          ...
                          <div className="text-sm text-gray-600">
                            Mean:{" "}
                            {datasetStats.feature_stats.accidents.mean.toFixed(
                              2,
                            )}
                            <br />
                  ...
                  <CardContent className="pt-6">
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">
                        No dataset found. Generate a dataset in the ML Models
                        tab.
                      </p>
                    </div>
                  </CardContent>
